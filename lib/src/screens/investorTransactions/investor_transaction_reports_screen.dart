...
class InvestorTransactionReportScreen extends StatefulWidget {
  ...
  @override
  State<InvestorTransactionReportScreen> createState() =>
      _InvestorTransactionReportScreenState();
}

class _InvestorTransactionReportScreenState
    extends State<InvestorTransactionReportScreen> {
  DateTime? _fromDate;
  DateTime? _toDate;
  ...
  Future<void> _loadFormData() async {
    ...
    try {
      ...
      await _controller.getInvestorBaseData();
    } catch (e) {
  ...
  Future<void> _generateReport() async {
    ...
    try {
      ...
      final bool success = await _controller.postInvestorTransactionReports(
        fromDateFormatted,
        toDateFormatted,
        _selectedInvestorId,
        _selectedCurrencyId,
      ...
      // Always ensure we reset the flag, even if there's an error
      if (mounted) {
        setState(() {
