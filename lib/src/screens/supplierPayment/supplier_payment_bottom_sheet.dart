...
class SupplierPaymentBottomSheet extends StatefulWidget {
  final int id;

  const SupplierPaymentBottomSheet({super.key, required this.id});

  @override
  State<SupplierPaymentBottomSheet> createState() =>
      _SupplierPaymentBottomSheetState();
}

class _SupplierPaymentBottomSheetState
    extends State<SupplierPaymentBottomSheet> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      _controller = context.read<SupplierPaymentController>();
      _controller.getSupplierPaymentDetail(widget.id);
    });
  }

  @override
  void dispose() {
    _controller.clearSupplierPaymentDetail();
    super.dispose();
  }
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          // Content
          Expanded(
            child: Consumer<SupplierPaymentController>(
  ...
  Widget _buildContent(SupplierPaymentController controller) {
    // Loading State
      ...
      return const Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 16),
            Text(
              'Loading supplier payment details...',
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton.icon(
                onPressed: () => controller.getSupplierPaymentDetail(widget.id),
    ...
    // Success State
    if (controller.supplierPaymentDetail == null) {
      return const Center(
        child: Text(
    ...
    return _buildDetailContent(controller.supplierPaymentDetail!);
  }

  Widget _buildDetailContent(SupplierPaymentDetail detail) {
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoCard(
            ...
            children: [
              _buildInfoRow('Supplier Name', detail.supplierName),
  ...
  Widget _buildAmountCard(SupplierPaymentDetail detail) {
    return Card(
      elevation: 2,
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
      child: Padding(
