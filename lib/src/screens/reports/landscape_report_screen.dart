...
class LandscapeReportScreen extends StatefulWidget {
  ...
  @override
  State<LandscapeReportScreen> createState() => _LandscapeReportScreenState();
}

class _LandscapeReportScreenState extends State<LandscapeReportScreen> {
  DateTime? _fromDate;
  DateTime? _toDate;
  ...
  static const landscapeExpenseFilter = [
    {'id': 'all', 'Name': 'All'},
    {'id': 'with', 'Name': 'With'},
  ...
  Future<void> _generateReport() async {
    ...
    try {
      ...
      final isSuccess = await _controller.postLandscapeExpenseReportsData(
        fromDateFormatted,
        toDateFormatted,
              ...
              child: Column(
                ...
                children: [
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    isExpanded: true,
                    items:
                        landscapeExpenseFilter.map((filter) {
