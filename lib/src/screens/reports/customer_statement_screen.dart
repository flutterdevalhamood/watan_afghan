...
class _CustomerStatementScreenState extends State<CustomerStatementScreen> {
  ...
  Future<void> _generateReport() async {
    ...
    try {
      ...
      final isSuccess = await _controller.postCustomerStatement(
        fromDateFormatted,
        toDateFormatted,
        _selectedCurrencyId,
        _selectedCustomerId,
            ...
            IconButton(
              ...
              onPressed:
                  () => PdfShareHelper.sharePdf(
                    context: context,
                    pdfPath: _pdfPath!,
                    subject: 'Customer Statement Report',
                    text:
                        'Customer Statement Report from ${DateFormat('MMM dd, yyyy').format(_fromDate!)} to ${DateFormat('MMM dd, yyyy').format(_toDate!)}',
                  ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  DropdownButtonFormField<int>(
                    ...
                    isExpanded: true,
                    items: [
                      ..._salesController.customer?.map((customer) {
                            return DropdownMenuItem<int>(
                              value: customer['id'],
