...
class CustomerAdvanceDataScreen extends StatefulWidget {
  const CustomerAdvanceDataScreen({super.key});

  @override
  State<CustomerAdvanceDataScreen> createState() =>
      _CustomerAdvanceDataScreenState();
}

class _CustomerAdvanceDataScreenState extends State<CustomerAdvanceDataScreen> {
